...
class Scoreboard:
    ...
    def __init__(self, ai_settings, screen, stats):
        ...
        self.high_score_font = pygame.font.SysFont("", 48)
    ...
    def prep_score(self):
        """
            将得分转换为一幅渲染的图像
        """
        rounded_score = round(self.stats.score, -1)  # 转换成10的整数倍
    ...
    def prep_high_score(self):
        ...
        self.high_score_image = self.high_score_font.render(high_score_str, True,
